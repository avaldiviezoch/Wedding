(()=>{
  ...
  const ROOT_ID='inv6-gift-rebuild';
  const STYLE_ID='inv6-gift-rebuild-style';
  const LEGACY_ID='sat-inv6-gift-paper-wrap';
  ...
  function ensureStyle(d){
    ...
    s.textContent=`
      ...
      #${ROOT_ID} .inv6-gift-sheet{
        position:relative!important;
        width:100%!important;
        margin:0!important;
        padding:78px 34px 72px!important;
      ...
      #${ROOT_ID} .inv6-gift-sheet::before{
        content:""!important;
      ...
      #${ROOT_ID} .inv6-gift-content{position:relative!important;z-index:2!important;max-width:470px!important;margin:0 auto!important}
      #${ROOT_ID} .inv6-gift-kicker{
        margin:0!important;
      ...
      #${ROOT_ID} .inv6-gift-toggle-icon{font-size:15px!important;line-height:1!important;transition:transform .22s ease!important}
      #${ROOT_ID}.is-open .inv6-gift-toggle-icon{transform:rotate(180deg)!important}
      #${ROOT_ID} .inv6-gift-details{
      ...
      #${ROOT_ID}.is-open .inv6-gift-details{display:block!important}
      #${ROOT_ID} .inv6-gift-details-intro{margin:0 0 10px!important;font:italic 12px/1.4 Georgia,'Times New Roman',serif!important;color:#687052!important}
      #${ROOT_ID} .inv6-gift-method{padding:13px 0!important;border-top:1px solid rgba(109,117,89,.14)!important}
      #${ROOT_ID} .inv6-gift-method:first-of-type{border-top:0!important}
      #${ROOT_ID} .inv6-gift-method-title{margin:0 0 8px!important;font-family:'Inv6SeasonsReal',Georgia,serif!important;font-size:20px!important;line-height:1!important;font-weight:500!important;color:#5D644F!important}
      #${ROOT_ID} .inv6-gift-row{display:flex!important;align-items:center!important;justify-content:space-between!important;gap:10px!important;margin-top:7px!important;padding:9px 10px!important;background:rgba(255,255,255,.38)!important;border:1px solid rgba(109,117,89,.12)!important;border-radius:12px!important;text-align:left!important}
      #${ROOT_ID} .inv6-gift-row-text{min-width:0!important;flex:1!important}
      #${ROOT_ID} .inv6-gift-label{display:block!important;margin:0 0 2px!important;font:700 8px/1.1 Georgia,'Times New Roman',serif!important;letter-spacing:.7px!important;text-transform:uppercase!important;color:#7A806A!important}
      #${ROOT_ID} .inv6-gift-value{display:block!important;margin:0!important;font:600 11px/1.3 Georgia,'Times New Roman',serif!important;color:#525A46!important;overflow-wrap:anywhere!important}
      #${ROOT_ID} .inv6-gift-copy-btn{flex:0 0 auto!important;margin:0!important;padding:7px 9px!important;border:1px solid rgba(109,117,89,.25)!important;border-radius:999px!important;background:#FBF8EF!important;color:#5D644F!important;font:700 8px/1 Georgia,'Times New Roman',serif!important;letter-spacing:.55px!important;cursor:pointer!important}
      #${ROOT_ID} .inv6-gift-qr{display:block!important;width:108px!important;max-width:42%!important;height:auto!important;margin:6px auto 0!important;padding:5px!important;background:#fff!important;border:1px solid rgba(109,117,89,.12)!important;border-radius:12px!important}
      #giftSection{display:none!important}
      @media(max-width:390px){
        #${ROOT_ID} .inv6-gift-sheet{padding:64px 24px 62px!important}
        #${ROOT_ID} .inv6-gift-copy{font-size:13px!important;line-height:1.44!important}
        #${ROOT_ID} .inv6-gift-details{width:90%!important;padding-left:12px!important;padding-right:12px!important}
      }
    `;
  }
  ...
  function mount(){
    const d=deepestDoc();
    if(!d)return false;
    const anchor=d.getElementById('inv5GiftInRsvp');
    if(!anchor?.parentNode)return false;

    ensureStyle(d);

    d.getElementById(LEGACY_ID)?.remove();
