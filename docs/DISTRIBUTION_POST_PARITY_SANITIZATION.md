...
- Pointer Events;
- `touch-action:none`;
- cancelación de drag al entrar el segundo dedo;
- safe areas iOS;
- FAB y sheets cerrados en P2.1.

## 6. Conflictos extremos

Los tests cubren ahora:

- escalas 18, 32 y 50 px/m;
- SAT con rectángulos rotados;
- solape y separación física equivalente entre escalas;
- círculo/círculo y círculo/polígono mediante tolerancias físicas;
- límites de elementos rotados cerca del borde.

## Gate

Este bloque NO agrega:

- mesas cuadradas;
- mesas rectangulares;
- capacidades 4–16;
- nuevas dimensiones físicas;
- integración real con App Lu;
- persistencia.
