(() => {
  ...
  const NEW_DISTRIBUTION_URL = new URL('distribucion/index.html?v=20260918-production3', document.baseURI).href;
  ...
  function mountNewDistribution() {
    ...
    workspace.querySelectorAll('iframe').forEach(other => {
