(() => {
  ...
  const VERSION = '20260819-1500-rsvp-publication-views1';
  ...
  function loadBaseRuntime() {
    ...
    baseRuntime = Promise.all([
      import(moduleUrl('index.js', '20260819-1500-publication-views1')),
  ...
  function loadRsvpRuntime() {
    ...
    rsvpRuntime = Promise.all([
      import(moduleUrl('rsvp-admin-music.js', '20260819-1500-publication-views1')),
